...
urlpatterns = [
    ...
    path('switchimp1/<str:pk>/<str:stat1', views.Toggleimp1,name='toggleimp'),
    path('switchimp2/<str:pk>/<str:stat2', views.Toggleimp2,name='toggleimp2'),
    path('switchimp3/<str:pk>/<str:stat3', views.Toggleimp3,name='toggleimp3'),
